...
class TestGetRestaurantsData(unittest.TestCase):
    ...
    def test_valid_data(self, mock_request):
        ...
        msg = f"""{emojis['rocket']} Getting data from 1 restaurants in postcode 12345...
                  {emojis['checkMark']} Data found! Retrieving data...
                  {emojis['sushi']} Printing data from 1 restaurants with postcode 12345 in Test City...\n
